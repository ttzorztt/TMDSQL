...
int Table::returnCount() { return Table::count; }
bool Table::isExist() { return _super::isExist(this->returnName(), style); }
...
bool Table::append(Table table, vstring value) { return table.append(value); }
...
bool Table::appInsertIndex(std::string tableName, std::string index,
                           POINTER fileIndex) {
